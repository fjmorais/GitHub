...
WHERE
 ...
 AND page_count > 1000
 and avg_fragmentation_in_percent > 30
 AND t.[name] not in ( 'MOVCOMISSAO','ELMAH_Error','dbo_CONTRATO_CT',
 'Tb_ProcessosFaturamento_HistoricoEmissaoAnalitico',
 'FUNDOSLD',
 't_Produtor_Comissao_Ativo',
't_Regras_Comissao_Ativo',
'T_LOG_FECHA_FUNDOS_DETALHADO',
'CERTIFIC',
'lsn_time_mapping')
 GROUP BY isnull (i.[name],'PK_CLUSTER'),
	t.[name] ,
