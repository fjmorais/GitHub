...
and o.name NOT IN  ( 'syscolpars', 'sysobjvalues', 'sysidxstats','plan_persist_runtime_stats_interval','plan_persist_query','plan_persist_plan','plan_persist_runtime_stats','plan_persist_wait_stats') and object_name(s.object_id) not like 'comis%' and object_name(s.object_id) not like 'premio%' and object_name(s.object_id) not like 'tbl_relatorio%' and object_name(s.object_id) not like 'sys%' and object_name(s.object_id) not like 'sql%'   
